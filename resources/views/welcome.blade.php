    ...
    <div class="container-fluid padding mt-5">
        ...
        <div class="container padding">
            <div class="row border-bottom mt-5">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="">
                        <div class="card-body mb-5">
                            <p class="">MARK TWAIN  /  FEBRUARY 5, 2017</p>
                            <h3 class="">LAUNCH YOUR BUSINESS WITH  EASIEST WAY</h3>
                            <p class="">This is description about this title. In this content you can
                            writing anything which is reading by visitors. Your article
                            has information about your subjects.</p>
                            <div class="">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="mt-3">
                        <img class="card-img-top" src="{{asset('website')}}/img/blog-1.jpg" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="row border-bottom mt-5">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="">
                        <div class="card-body mb-5">
                            <p class="">MARK TWAIN  /  FEBRUARY 3, 2017</p>
                            <h3 class="">LAUNCH YOUR BUSINESS WITH  EASIEST WAY</h3>
                            <p class="">This is description about this title. In this content you can
                            writing anything which is reading by visitors. Your article
                            has information about your subjects.</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="mt-3">
                        <img class="card-img-top" src="{{asset('website')}}/img/blog-2.jpg" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="row border-bottom mt-5">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="mt-3">
                        <img class="card-img-top" src="{{asset('website')}}/img/blog-3.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="row mt-5">
